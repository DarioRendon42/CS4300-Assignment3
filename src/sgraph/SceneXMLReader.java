...
public class SceneXMLReader {
  ...
  importScenegraph(InputStream in, VertexProducer<K> vProducer)
          throws Exception {
...
class MyHandler<K extends IVertexData> extends DefaultHandler {
  private VertexProducer<? extends IVertexData> vProducer;
  ...
  public MyHandler(VertexProducer<K> vProducer) {
